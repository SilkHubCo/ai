...
For example, Anthropic's Google Cloud client can discover credentials through
Application Default Credentials:

```bash
npm install @tanstack/ai-anthropic@npm:@silkhubco/ai-anthropic @anthropic-ai/vertex-sdk
```
